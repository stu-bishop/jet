...
CODE_DIR="../../../../code/uv_sponge"
MKMF_PATH="$MOM6_EXAMPLES/src/mkmf/bin"

rm -f path_names
$MKMF_PATH/list_paths -l ./ $CODE_DIR $MOM6_EXAMPLES/src/MOM6/{config_src/infra/FMS2,config_src/memory/dynamic_symmetric,config_src/drivers/solo_driver,config_src/external,src/{*,*/*}}
